...
# Live:
# fab deploy:host=django@atange.com
...
APP_NAME = 'howx'
REPO_URL = "git@github.com:jarnoln/how-x-are-you.git"
LOCAL_SITE_NAME = '{}.net'.format(APP_NAME)
...
def get_site_name():
    if env.host == 'localhost' or env.host.startswith('1'):
...
def _update_settings(source_folder):
    settings_path = source_folder + '/howx/settings.py'
